    ...
    <div className="h-full">
      <ScrollArea className="h-full">
        <div className="relative min-h-full">
          <div
            className="absolute inset-0 bg-gradient-to-b from-[#FF4070]/80 via-zinc-900/80 to-zinc-900 pointer-events-none"
            aria-hidden="true"
          />
          ...
          <div className="relative z-10">
            <div className="flex p-6 gap-6 pb-8">
              ...
              <div className="flex flex-col justify-end">
                ...
                <h1 className="text-6xl font-bold my-4">{currAlbum?.title}</h1>
            ...
            <div className="px-6 pb-4 flex items-center gap-6">
              <Button
                size="icon"
                className="w-14 h-14 rounded-full bg-[#e7436c] hover:bg-[#ff4070] 
