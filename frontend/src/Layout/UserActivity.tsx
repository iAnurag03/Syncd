    ...
    <div className='h-full bg-zinc-900 rounded-lg flex flex-col'>
      <div className='p-4 flex justify-between items-center border-b border-zinc-800'>
        <div className="flex items-center gap-2">
          <Users className="size-5 shrink-0 text-[#e7436c]" />
              ...
              <div className='flex items-start gap-3'>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {isPlaying && <Music className="size-3.5 text-[#e7436c] shrink-0" />}
                  </div>
                  {isPlaying ? (
                    <div className="mt-1">
...
const LoginPrompt = () => (
  <div className="h-full flex flex-col items-center justify-center p-6 text-center space-y-4">
    <div className="relative">
      <div
        className="absolute -inset-1 bg-gradient-to-r from-[#e7436c] to-red-600 rounded-full blur-lg
       opacity-75 animate-pulse"
        aria-hidden="true"
      />
      <div className="relative bg-zinc-900 rounded-full p-4">
        <HeadphonesIcon className="size-8 text-[#e7436c]" />
      </div>
    </div>
